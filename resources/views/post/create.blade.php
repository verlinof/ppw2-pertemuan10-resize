...
<div class="w-full mt-20 flex justify-center">
    <div class="flex items-center md:w-[400px] lg:w-[500px] h-max p-8 md:p-9 lg:p-10 bg-white rounded-xl">
        <div class="w-full">
            <p class="top-0 text-center text-xl md:text-2xl lg:text-3xl font-bold mb-6">Buat Postingan</p>
            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-2 lg:mb-2">
                    ...
                    <input name="title" type="text" id="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 lg:p-4 @error('title') border-red-500 placeholder-red-400 @enderror" placeholder="A Title of image">
                ...
                <div class="mb-2 lg:mb-2">
                    ...
                    <input name="description" type="text" id="description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 lg:p-4 @error('description') border-red-500 placeholder-red-400 @enderror" placeholder="Description of the image">
                ...
                <button type="submit" class="text-white bg-primary-color hover:bg-secondary-color focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm md:text-lg w-full py-2.5 text-center">Post</button>
            </form>
        </div>
    </div>
</div>
